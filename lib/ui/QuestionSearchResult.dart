...
class QuestionSearchResult extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print("inside questions view");
    return buildQuestionsView(context);
  }

  Widget buildQuestionsView(BuildContext context) {
  ...
  Widget createPhotoView(BuildContext context) {
    return SliverList(
      ...
      String random =
          "listTag" + questionCardList[position].questionId.toString();
      return GestureDetector(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            _label(
                                questionCardList[position].viewCount.toString(),
                                14),
                          ],
                        ),
                      ),
                      Row(
                        children: <Widget>[
                          ...
                          _label(
                              questionCardList[position].answerCount.toString(),
                              12)
                        ],
                      ),
                      Row(
                        children: <Widget>[
                          ...
                          _label(
                              questionCardList[position].score.toString(), 12),
                        ],
                      )
                    ],
                  ),
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              _label(
                                  questionCardList[position].owner.displayName,
                                  12),
                            ],
                          ),
                        ],
          ...
          onTap: () => {
                AppNavigator.navigateToDetailWebView(
                    context, questionCardList[position].link,questionCardList[position].title)
              });
